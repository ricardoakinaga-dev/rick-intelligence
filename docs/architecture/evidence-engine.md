...
Citation quality is measured with precision, recall, completeness, correctness
and unsupported-claim rate. Local fixtures are synthetic; clinical corpus
quality, licensing and external validation remain separate promotion gates.
