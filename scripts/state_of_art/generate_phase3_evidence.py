...
def _capability_definitions() -> tuple[dict[str, Any], ...]:
    ...
    return (
        ...
        },
        {
            ...
            "priority": "P1",
            "status": "NOT_RUN",
            "code_tests": ["infrastructure/scripts/backup-restore-check.py", "infrastructure/scripts/backup_restore.py", "docs/operations/release-readiness.md", "scripts/state_of_art/phase3_lane.py", "scripts/state_of_art/run_phase3_operational.py", "scripts/state_of_art/tests/test_phase3_lane.py"],
            "artifacts": common + [("docs/operations/release-readiness.md", "release/restore readiness contract"), ("scripts/state_of_art/phase3_lane.py", "bounded performance/chaos/soak lane harness"), ("scripts/state_of_art/run_phase3_operational.py", "commit-bound operational lane adapter")],
            "runtime_evidence": [(".runtime/phase-3/performance-runtime-evidence.json", "performance runtime lane envelope"), (".runtime/phase-3/chaos-runtime-evidence.json", "chaos runtime lane envelope"), (".runtime/phase-3/soak-runtime-evidence.json", "soak runtime lane envelope")],
