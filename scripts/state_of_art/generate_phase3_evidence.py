...
def _capability_definitions() -> tuple[dict[str, Any], ...]:
    ...
    return (
        ...
        },
        {
            ...
            "priority": "P0",
            "status": "BLOCKED_EXTERNAL",
            "code_tests": ["scripts/phase11/redis_runtime_gate.py", "scripts/state_of_art/run_phase3_redis.py", "packages/locking/pyproject.toml", "Makefile"],
            "artifacts": common + [("scripts/phase11/redis_runtime_gate.py", "Redis runtime gate"), ("scripts/state_of_art/run_phase3_redis.py", "Phase 3 commit-bound Redis evidence adapter")],
            "runtime_evidence": [(".runtime/phase-3/redis-runtime-evidence.json", "Redis runtime evidence envelope")],
