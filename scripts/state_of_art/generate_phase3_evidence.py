...
def _capability_definitions() -> tuple[dict[str, Any], ...]:
    ...
    return (
        ...
        },
        {
            ...
            "priority": "P0",
            "status": "BLOCKED_EXTERNAL",
            "code_tests": ["scripts/phase11/redis_runtime_gate.py", "scripts/phase11/redis_multi_replica_runtime_gate.py", "scripts/state_of_art/run_phase3_redis.py", "scripts/state_of_art/run_phase3_redis_multi_replica.py", "packages/locking/pyproject.toml", "Makefile"],
            "artifacts": common + [("scripts/phase11/redis_runtime_gate.py", "Redis lease/runtime gate"), ("scripts/phase11/redis_multi_replica_runtime_gate.py", "two-process Redis multi-replica gate"), ("scripts/state_of_art/run_phase3_redis.py", "Phase 3 commit-bound Redis evidence adapter"), ("scripts/state_of_art/run_phase3_redis_multi_replica.py", "Phase 3 commit-bound multi-replica Redis evidence adapter")],
            ...
            "limitations": "No live Redis endpoint or two-process replica run is available; the gate remains fail-closed until an approved endpoint and driver are supplied.",
            "next_action": "Execute two API replicas against the same Redis, then run TTL, fencing, rate-limit and unavailable-broker cases.",
        },
        {
            "capability_id": "P0-07",
