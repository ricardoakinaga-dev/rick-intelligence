...
def _capability_definitions() -> tuple[dict[str, Any], ...]:
    ...
    return (
        ...
        },
        {
            ...
            "priority": "P0",
            "status": "BLOCKED_EXTERNAL",
            "code_tests": ["apps/worker/external_ingestion.py", "apps/api/src/services/postgres_ingestion.py", "infrastructure/migrations/0006_document_lineage_contract.sql", "scripts/phase11/golden_runtime_gate.py", "scripts/state_of_art/run_phase3_golden_runtime.py"],
            "artifacts": common + [("apps/worker/external_ingestion.py", "external ingestion bridge"), ("infrastructure/migrations/0006_document_lineage_contract.sql", "lineage contract"), ("scripts/phase11/golden_runtime_gate.py", "golden ingestion and lineage runtime gate"), ("scripts/state_of_art/run_phase3_golden_runtime.py", "Phase 3 golden runtime evidence adapter")],
            "runtime_evidence": [(".runtime/phase-3/golden-ingestion-runtime-evidence.json", "golden ingestion runtime evidence envelope")],
        ...
        },
        {
            ...
            "priority": "P1",
            "status": "BLOCKED_EXTERNAL",
            "code_tests": ["packages/providers/pyproject.toml", "apps/api/src/services/professor_backend.py", "docs/evaluation/packs/rec22-local-v1/manifest.json", "scripts/phase11/provider_runtime_gate.py", "scripts/state_of_art/run_phase3_provider.py"],
            "artifacts": common + [("apps/api/src/services/professor_backend.py", "provider boundary"), ("docs/evaluation/packs/rec22-local-v1/manifest.json", "offline evaluation pack"), ("scripts/phase11/provider_runtime_gate.py", "OpenAI-compatible provider runtime gate"), ("scripts/state_of_art/run_phase3_provider.py", "Phase 3 provider runtime evidence adapter")],
            "runtime_evidence": [(".runtime/phase-3/provider-runtime-evidence.json", "provider runtime evidence envelope")],
        ...
        },
        {
            ...
            "priority": "P1",
            "status": "PARTIAL",
            "code_tests": ["docs/evaluation/packs/rec22-local-v1/manifest.json", "scripts/state_of_art/evaluate_pack.py", "scripts/state_of_art/evaluate_retrieval.py", "scripts/phase11/tenant_evidence_runtime_gate.py", "scripts/state_of_art/run_phase3_tenant_evidence.py"],
            "artifacts": common + [("docs/evaluation/packs/rec22-local-v1/manifest.json", "synthetic offline pack"), ("scripts/state_of_art/evaluate_retrieval.py", "retrieval evaluator"), ("scripts/phase11/tenant_evidence_runtime_gate.py", "multi-tenant/evidence negative runtime gate"), ("scripts/state_of_art/run_phase3_tenant_evidence.py", "Phase 3 tenant/evidence evidence adapter")],
            "runtime_evidence": [(".runtime/phase-3/tenant-evidence-runtime-evidence.json", "tenant/evidence runtime evidence envelope")],
        ...
        },
        {
            ...
            "priority": "P1",
            "status": "PARTIAL",
            "code_tests": ["infrastructure/compose/otel-collector-config.yaml", "infrastructure/compose/prometheus.yml", "docs/operations/slo.md", "scripts/phase11/observability_runtime_gate.py", "scripts/state_of_art/run_phase3_observability.py"],
            "artifacts": common + [("infrastructure/compose/otel-collector-config.yaml", "OTel collector configuration"), ("docs/operations/slo.md", "SLO contract"), ("scripts/phase11/observability_runtime_gate.py", "observability runtime gate"), ("scripts/state_of_art/run_phase3_observability.py", "Phase 3 observability evidence adapter")],
            "runtime_evidence": [(".runtime/phase-3/observability-runtime-evidence.json", "observability runtime evidence envelope")],
        ...
        },
        {
            ...
            "priority": "P1",
            "status": "NOT_RUN",
            "code_tests": ["infrastructure/scripts/backup-restore-check.py", "infrastructure/scripts/backup_restore.py", "docs/operations/release-readiness.md", "scripts/phase11/restore_runtime_gate.py", "scripts/state_of_art/run_phase3_restore.py", "scripts/state_of_art/tests/test_restore_runtime.py", "scripts/state_of_art/phase3_lane.py", "scripts/state_of_art/run_phase3_operational.py", "scripts/state_of_art/tests/test_phase3_lane.py"],
            "artifacts": common + [("docs/operations/release-readiness.md", "release/restore readiness contract"), ("scripts/phase11/restore_runtime_gate.py", "authorized disposable restore runtime gate"), ("scripts/state_of_art/run_phase3_restore.py", "commit-bound restore runtime adapter"), ("scripts/state_of_art/phase3_lane.py", "bounded performance/chaos/soak lane harness"), ("scripts/state_of_art/run_phase3_operational.py", "commit-bound operational lane adapter")],
            "runtime_evidence": [(".runtime/phase-3/performance-runtime-evidence.json", "performance runtime lane envelope"), (".runtime/phase-3/chaos-runtime-evidence.json", "chaos runtime lane envelope"), (".runtime/phase-3/soak-runtime-evidence.json", "soak runtime lane envelope"), (".runtime/phase-3/restore-runtime-evidence.json", "restore runtime lane envelope")],
        ...
        },
        {
            ...
            "priority": "P1",
            "status": "PARTIAL",
            "code_tests": ["apps/web/package.json", "apps/web/playwright.config.ts", "docs/operations/slo.md", "scripts/phase11/frontend_supply_runtime_gate.py", "scripts/state_of_art/run_phase3_frontend_supply.py"],
            "artifacts": common + [("apps/web/package.json", "frontend scripts"), ("apps/web/playwright.config.ts", "browser harness"), ("scripts/phase11/frontend_supply_runtime_gate.py", "frontend/accessibility/supply runtime gate"), ("scripts/state_of_art/run_phase3_frontend_supply.py", "Phase 3 frontend/supply evidence adapter")],
            "runtime_evidence": [(".runtime/phase-3/frontend-supply-runtime-evidence.json", "frontend/accessibility/supply runtime evidence envelope")],
        ...
        {
            "capability_id": "P1-09",
            "title": "File-ingestion security and process isolation",
            "priority": "P1",
            "status": "LOCAL_VERIFIED",
            "code_tests": ["packages/ingestion/src/rick_ingestion/parsers.py", "apps/worker/README.md", "scripts/phase11/file_security_runtime_gate.py", "scripts/state_of_art/run_phase3_file_security.py", "scripts/state_of_art/tests/test_file_security_runtime.py"],
            "artifacts": common + [("scripts/phase11/file_security_runtime_gate.py", "file-security and process-isolation runtime gate"), ("scripts/state_of_art/run_phase3_file_security.py", "Phase 3 file-security evidence adapter"), ("scripts/state_of_art/tests/test_file_security_runtime.py", "file-security gate contract tests")],
            "runtime_evidence": [(".runtime/phase-3/file-security-runtime-evidence.json", "file-security runtime evidence envelope")],
            "limitations": "Parser bounds and hermetic gate contracts are locally verified; no hostile corpus has been run in an authorized isolated external worker.",
            "next_action": "Execute the ten-case hostile corpus in an authorized disposable worker and bind process, resource, timeout and redaction evidence.",
        },
        {
            "capability_id": "P1-08",
