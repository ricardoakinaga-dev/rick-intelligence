...
def _capability_definitions() -> tuple[dict[str, Any], ...]:
    ...
    return (
        ...
        },
        {
            ...
            "priority": "P0",
            "status": "BLOCKED_EXTERNAL",
            "code_tests": ["apps/worker/runtime.py", "apps/worker/canonical_queue.py", "apps/worker/tests/test_runtime.py"],
            "artifacts": common + [("apps/worker/runtime.py", "real worker runtime"), ("apps/worker/canonical_queue.py", "canonical queue")],
            "limitations": "No two-process worker, SIGTERM, crash/restart or stale-fence runtime observation exists.",
            "next_action": "Run Worker A/B ownership, fencing, crash, replay and timeout gates.",
        },
        {
            "capability_id": "P0-06",
            ...
            "priority": "P0",
            "status": "BLOCKED_EXTERNAL",
            "code_tests": ["scripts/phase11/redis_runtime_gate.py", "packages/locking/pyproject.toml", "Makefile"],
            "artifacts": common + [("scripts/phase11/redis_runtime_gate.py", "Redis runtime gate")],
            "limitations": "No live Redis endpoint or replica/failover run is available.",
            "next_action": "Execute replica, TTL, fencing, rate-limit and unavailable-broker cases.",
        },
        {
            "capability_id": "P0-07",
            ...
            "priority": "P0",
            "status": "BLOCKED_EXTERNAL",
            "code_tests": ["scripts/phase11/object_qdrant_runtime_gate.py", "packages/storage/pyproject.toml", "packages/knowledge/src/rick_knowledge/models.py"],
            "artifacts": common + [("scripts/phase11/object_qdrant_runtime_gate.py", "object/vector runtime gate")],
