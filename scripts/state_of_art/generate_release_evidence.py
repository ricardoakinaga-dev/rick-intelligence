...
DEFAULT_ARTIFACTS = (
    ...
    "docs/prompts/triple-aaa-runtime-closure-2026-09-10.txt",
    "docs/reports/current-triple-aaa-gap-audit.md",
    "docs/reports/triple-aaa-runtime-closure-current-audit.md",
    ...
    "packages/observability/src/rick_observability/tracing.py",
    "packages/observability/src/rick_observability/__init__.py",
    "packages/observability/tests/test_observability.py",
    "apps/api/tests/test_otel.py",
    "infrastructure/compose/bootstrap_qdrant.py",
    "infrastructure/compose/bootstrap_object_store.sh",
    ...
    "apps/api/src/dependencies/identity.py",
    "apps/api/src/routes/knowledge.py",
    "apps/api/src/services/authorization_service.py",
    "apps/api/src/services/postgres_ingestion.py",
    ...
    "infrastructure/docker/worker-entrypoint.py",
    "infrastructure/docker/tests/test_worker_entrypoint.py",
    "apps/worker/runtime.py",
    "apps/worker/external_ingestion.py",
    "apps/worker/tests/test_runtime.py",
    "packages/jobs/src/rick_jobs/contracts.py",
    "packages/jobs/tests/test_contracts.py",
    "packages/retrieval/src/rick_retrieval/qdrant.py",
    "packages/retrieval/tests/test_qdrant.py",
    "packages/providers/src/rick_providers/client.py",
    ...
    "scripts/state_of_art/tests/test_qdrant_bootstrap.py",
