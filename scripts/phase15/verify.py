#!/usr/bin/env python3
"""Run the Phase 1.5 verification matrix and write sanitized evidence.

The artifact stores command identity and pass/fail summaries only. It never
stores command output, request bodies, credentials, URLs, or exception text.
"""
...
def main() -> int:
    ...
    benchmark_path = ROOT / "docs" / "progress" / "phase-1.5-perf.json"
