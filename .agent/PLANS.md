...
plan is `.agent/plans/phase-3-runtime-evidence-production-promotion.md`; the
prior REC/Phase 2 plans and gates remain historical context and are not
rewritten. Pre-v2 gates and ledgers are preserved byte-for-byte under
`.agent/legacy-v1/`; its manifest maps original paths to their archived
locations. The
